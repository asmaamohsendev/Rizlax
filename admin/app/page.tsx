...
export default function HomePage() {
  const { login, isLoading, error, setLoading, setError, clearError, user, isInitialized } = useAuth();
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-black">
        <div className="text-[#C2EE71] flex items-center gap-3">
          ...
          <div className="w-2 h-2 bg-[#C2EE71] rounded-full animate-pulse" style={{ animationDelay: '0.15s' }}></div>
          <div className="w-2 h-2 bg-[#C2EE71] rounded-full animate-pulse" style={{ animationDelay: '0.3s' }}></div>
        </div>
      </div>
    );
  }
  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-black p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-[#C2EE71]/3 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
      </div>
        ...
        <div className="bg-black/40 backdrop-blur-md rounded-2xl shadow-2xl p-8 border border-[#C2EE71]/20">
          ...
          <div className="mt-6 pt-6 border-t border-[#C2EE71]/20">
            <div className="flex items-center justify-center space-x-2 text-[#C2EE71]/50 text-xs">
              ...
              <span className="uppercase tracking-wider font-light">Secure Connection</span>
            </div>
          </div>
        </div>
