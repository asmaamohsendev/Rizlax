    ...
    return (
        <section className="section-container py-20 text-center">
            <div className="flex flex-col gap-16 h-32">
                <h1
                    className="font-bold text-5xl bg-gradient-to-r
                    from-[#23343D] via-[#598671] to-[#23343D]
                    ...
                    >
                        ...
                        <div className="flex flex-col text-left justify-between w-[347px] h-[238px] gap-2">
                            <div className="flex flex-col gap-2">
                                ...
                                <p className="text-[#DADADA] text-[13px]">
                                    Learn how to create a profile that attracts top <br />
                                    clients — from crafting your bio to showcasing your <br />
                                    best projects.
                                </p>
                            </div>
